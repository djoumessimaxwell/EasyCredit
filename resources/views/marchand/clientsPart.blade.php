...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Gestion de mes Clients: Particuliers
        </h1>
        <ol class="breadcrumb">
            <li><a href="/accueil"><i class="fa fa-home"></i> Accueil</a> > Clients(Particuliers)</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title col-xs-6">Mes Clients: Particulier</h3>
                        <div class="pull-right box-tools">
                            <button type="button" id='modal-part' class="btn btn-block btn-success col-xs-4" data-toggle="modal" data-target="#modal-danger4"><i class="fa fa-plus-circle"></i> Ajouter</button>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <button type="button" data-toggle="modal" data-target="#modal-danger" data-id="{{$user->id}}" data-name="{{$user->fullname}}" data-url="/marchand/client/activer/" class="activer btn btn-xs btn-success">Activer</button>
                                        </center>
                                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class='form-horizontal' id="activer-form" method="POST" action="">
                                    {{ csrf_field() }}
