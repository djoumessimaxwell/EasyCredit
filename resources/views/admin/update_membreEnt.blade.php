...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Modification du compte de : {{ $user->Raison_sociale }}
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-success">
                    <div class="tab-content">
                        <div class="active tab-pane box-body box-profile" id="first">
                            ...
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>Raison sociale</b> <a class="pull-right"><b>{{ $user->Raison_sociale }}</b></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Forme juridique</b> <a class="pull-right"><b>{{ $user->Forme_juridique }}</b></a>
                                </li>
                                <li class="list-group-item">
                        ...
                        <div class="tab-pane box-body" id="second">
                            ...
                            <form class="form-horizontal" method="POST" action="/admin/membreEnt/update/{{ $user->id }}">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Raison sociale</label>

                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $user->Raison_sociale }}" name="RS" class="form-control" placeholder="Entrer la raison sociale">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Forme juridique</label>

                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $user->Forme_juridique }}" name="FJ" class="form-control" placeholder="Entrer la forme juridique">
                                    </div>
                                </div>
                                <div class="form-group">
